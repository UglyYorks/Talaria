...
- (void)assignSharedLayoutTokens {
  ...
  self.userMessageTailHeight = self.userMessageCornerRadius * 10.0 / 35.0;
  ...
  self.suggestionCommandFont = [NSFont systemFontOfSize:self.bodyFont.pointSize weight:NSFontWeightSemibold];
