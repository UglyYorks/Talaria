...
.PHONY: test-browser-import-webkit
test-browser-import-webkit: build
	...
	xcrun clang++ $(APP_OBJCXXFLAGS) -ISource Tests/BrowserProfileImportWebKitTests.mm $(filter-out $(APP_OBJECT_DIR)/main.mm.o,$(APP_OBJECTS)) $(APP_FRAMEWORKS) -o "$(BUILD_DIR)/BrowserImportProbe.app/Contents/MacOS/Talaria"
