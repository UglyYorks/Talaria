...
static void TestProfileSchemaCompatibility(void) {
  ...
  for (NSNumber *withoutAttachments in @[@NO, @YES]) {
    ...
    Check([version step] == SQLITE_ROW && sqlite3_column_int(version.handle, 0) == 9, @"upgrades profile schema without downgrading its data");
    version = nil;
  ...
  fixture = [TLSQLiteConnection openURL:URL error:&error];
  Check([fixture executeSQL:"PRAGMA user_version = 10" error:&error], @"prepares unknown future schema");
  fixture = nil;
  error = nil;
...
static void TestVersion8Compatibility(void) {
  ...
  fixture = [TLSQLiteConnection openURL:URL error:&error];
  TLSQLiteStatement *version = [fixture prepareSQL:"PRAGMA user_version" error:&error];
  Check([version step] == SQLITE_ROW && sqlite3_column_int(version.handle, 0) == 9, @"never downgrades the database version");
  version = nil;
  ...
  model = nil;
  Check([fixture executeSQL:"PRAGMA user_version = 10" error:&error], @"prepares an unknown future version");
